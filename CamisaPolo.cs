...
namespace TP1
{
    public class CamisaPolo : Produto
    {
        public CamisaPolo (View view, int linha) : base(view, linha) { }
        ...
        protected override void ThreadProc()
        {
            ...
            view.atualizaLinha(linha, 1, "polo", true);
            Thread.Sleep(1000);
            ...
            view.atualizaLinha(linha, 1, "polo", false);
            ...
            view.atualizaLinha(linha, 2, "polo", true);
            Thread.Sleep(2000);
            // Indica que vai tentar pegar o proximo recurso
            ...
            // Retira a representação do processo anterior
            view.atualizaLinha(linha, 2, "polo", false);
            // Libera o recurso anterior
            recursos["maquinaCostura" + linha.ToString()].Release();
            // Representa a etapa do processo e simula o tempo de execução
            view.atualizaLinha(linha, 3, "polo", true);
